...
class HomeView(templates.TemplateView):
    text = (
        ...
        "🛠 *Как начать?*\n\n"
        "1. ✨ Нажмите на /start, чтобы активировать бота.\n"
        "2. 📚 Используйте команды или кнопки меню для работы с ботом.\n"
        "3. 🎬 Исследуйте мир кино и наслаждайтесь!\n\n"
...
class AboutBotView(templates.TemplateView):
    text = (
    "🤖 *О CinemaBot* 🎬\n\n"
    "CinemaBot — ваш персональный гид по миру кино прямо в Telegram! 🍿✨\n\n"
    "Мы создали CinemaBot, чтобы вы всегда могли быть в курсе последних фильмов, новинок, рейтингов, а также искать любимые фильмы и получать персонализированные рекомендации. 🎥🎞\n\n"
    "🌟 *Что может CinemaBot?*\n\n"
    "🔍 Поиск фильмов — получите полную информацию о любых фильмах.\n"
    "⭐️ Рейтинги и рецензии — читайте мнения зрителей и критиков.\n"
    "🎬 Трейлеры — смотрите самые актуальные трейлеры фильмов.\n"
    "🕒 Сеансы — находите ближайшие сеансы в кинотеатрах.\n"
    "📰 Новости — следите за горячими новинками и премьерами.\n"
    "🤖 Рекомендации — получайте подборки фильмов по вашим вкусам.\n\n"
    "Мы всегда работаем над улучшением бота, чтобы сделать ваш опыт максимально удобным и интересным! 🚀\n\n"
    "Если у вас есть предложения или вопросы, не стесняйтесь писать нам!"
)
...
class AboutBotReplyButtonView(templates.ReplyKeyboardButtonView):
    text = "🤖 О боте"
    pages = [HomeView]
    redirect_to = AboutBotView